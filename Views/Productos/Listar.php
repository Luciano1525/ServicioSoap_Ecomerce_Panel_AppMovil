                            ...
                            <tbody>
                                <?php foreach ($data as $cl) { ?>
                                    <tr>
                                        ...
                                        <td><img src="<?php echo base_url() . $cl['imagen']; ?>" alt="<?php echo $cl['nombre']; ?>" width="50"></td>
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <select id="categoria" class="form-control" name="categoria">
                <option value="1">Categoría 1: Pasteles</option>
                <option value="2">Categoría 2: CupCakes</option>
                <option value="3">Categoría 3: Tartas</option>
            </select>
        </div>
        <div class="form-group">
