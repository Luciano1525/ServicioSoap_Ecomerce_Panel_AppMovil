    ...
    public function ListaVentas(int $id_venta)
{
    ...
    $res = $this->select_all($sql);
    if (!$res) {
        error_log("Error al obtener datos de detalle_venta para id_venta: $id_venta");
    }
    return $res;
}
...
public function PdfCliente(int $id_cliente)
{
    ...
    $sql = "SELECT ruc, nombre, telefono FROM clientes WHERE id = $id_cliente";
    $res = $this->select($sql);
    if (!$res) {
        error_log("Error al obtener datos del cliente para id_cliente: $id_cliente");
    }
    return $res;
}
...
public function selectConfiguracion()
{
    ...
    $res = $this->select($sql);
    if (!$res) {
        error_log("Error al obtener datos de configuración");
    }
    return $res;
}
