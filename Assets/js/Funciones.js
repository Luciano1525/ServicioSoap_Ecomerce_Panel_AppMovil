            ...
            var myBarChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: "Stock",
                        data: cantidad,
                        backgroundColor: 'Yellow', // Todas las barras de color amarillo
                        borderColor: 'Yellow', // Bordes de las barras de color amarillo
                        borderWidth: 1,
                    }],
                },
                options: {
                    scales: {
                        xAxes: [{
                            ...
                            ticks: {
                                maxTicksLimit: Math.min(20, nombre.length) // Ajuste dinámico basado en la cantidad de productos
                            }
                        }],
                        yAxes: [{
                            ticks: {
                                min: 0,
                                max: Math.max(...cantidad) + 10, // Ajustar el valor máximo según el valor más alto en los datos
                                maxTicksLimit: 5
                            },
                            gridLines: {
                                display: true
...
function registrarCodigo(e) {
    e.preventDefault();
    const codigo = document.getElementById("codigo");
    if (codigo.value == "") {
        alertas('El Producto es requerido', 'warning');
    } else {
        const url = base_url + "Productos/insertar";
        const frm = document.getElementById("frmCodigo");
